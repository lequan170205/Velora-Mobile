...
// Must stay in sync with the backend reaction validator: reactions outside
// this set are rejected server-side, so no picker may offer more.
export const VALID_EMOJIS = ['👍', '❤️', '😂', '😢', '😮', '😡', '👏', '🎉'] as const

export const QUICK_REACTIONS = ['👍', '❤️', '😂', '😮', '😢'] as const

export const EXTENDED_EMOJIS = VALID_EMOJIS
